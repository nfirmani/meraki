...
import { ItNelsonBackendCommandContribution} from './it-nelson-backend-contribution';

export default new ContainerModule(bind => {
    bind(CommandContribution).to(ItNelsonBackendCommandContribution).inSingletonScope();
